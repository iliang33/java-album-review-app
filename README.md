...
- As a user, I want to be given the option to load all of my saved reviews and catgories  
- As a user, I want there to be auto saving and loading in case I forget to save or load manually   
