...
I built this project because I started fully listening to albums front to back when
...
- Create and remove album reviews with a name, artist, genre, rating, and review
- Add and remove tracklists to album reviews with each song having a rating
- Create and remove categories to group reviews
- Add and remove album reviews to categories  
- View all created reviews 
- Sort reviews by artist, name, or rating 
- Update existing reviews and categories   
- Merge tracklists of two albums together  
